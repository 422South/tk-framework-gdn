...
class WebsocketTransport(AbstractTransport):
    ...
    def recv_packet(self):
        try:
            ...
            # print("Websocket got packet %s" % packet_text)
        ...
        engineIO_packet_type, engineIO_packet_data = parse_packet_text(
            packet_text)
        # if int(engineIO_packet_type) != 3:
        # print("WS Packet Recieved %s --> %s" % (_packet_type_to_str(engineIO_packet_type), engineIO_packet_data))
        yield engineIO_packet_type, engineIO_packet_data
