...
class ProxyScope(object):
    ...
    def __getattr__(self, name):
        ...
        """
        try:
            self._communicator.log_network_debug("ProxyScope __getattr_ : %s" % name)
            _registry = self.__registry
...
class ProxyWrapper(object):
    ...
    def __call__(self, *args):
        ...
        the remote callable.
        """
        # TODO NEVER Add a logger call here as it hangs !! self._communicator.log_network_debug("ProxyWrapper __call_ : %s" % args)
    ...
    def __eq__(self, other):
        ...
        try:
            return cls._communicator.rpc_is_equal(self, other)
        except ValueError:
    ...
    def __iter__(self):
        ...
        """
        with cls._communicator.response_logging_silenced():
            try:
                i = 0
                while True:
                    yield self[i]
    ...
    def __getattr__(self, name):
        ...
        """
        self._communicator.log_network_debug("ProxyWrapper __getattr_ : %s" % name)
    ...
    def __getitem__(self, key):
        ...
        :param key: Some item key, whether it's an integer index or some bit
                    of hashable data.
        """
        return cls._communicator.rpc_get_index(self, key)
